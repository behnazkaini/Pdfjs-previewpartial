...
console.log("DEFAULT_RANGE_CHUNK_SIZE",DEFAULT_RANGE_CHUNK_SIZE);
    ...
    this._onComObjOnMessage = event => {
      ...
      if (data.callbackId) {
        ...
        new Promise(function (resolve) {
          ...
          if(result?.isStreamingSupported && result.isRangeSupported === false) {
            comObj.postMessage({
              sourceName: cbSourceName,
              targetName: cbTargetName,
              callback: CallbackKind.DATA,
              callbackId: data.callbackId,
              data:{...result,isRangeSupported:true}
            });
          }

          else comObj.postMessage({
            sourceName: cbSourceName,
            targetName: cbTargetName,
            callback: CallbackKind.DATA,
            callbackId: data.callbackId,
...
class NetworkManager {
  ...
  request(args) {
    ...
    if (this.isHttp && "begin" in args && "end" in args) {
      xhr.setRequestHeader("Range2", `bytes=${args.begin}-${args.end - 1}`);
